...
;if(b>0&&o&&t.transit.useTransitionEnd){i=true;a.bind(o,r)}else{
	if(a[0].timer){clearTimeout(a[0].timer)}
	a[0].timer= setTimeout(r,b);
	a[0].timerClear = function(){
		if(i){a.unbind(o,r)}
		//if(typeof s==="function"){s.apply(a)}
		clearTimeout(a[0].timer);
	};
}a.each(function(){if(b>0){this.style[n.transition]=p}t(this).css(l)})};var z=function(t){this.offsetWidth;v(t)};c(a,f,z);return this};function p(e,i){if(!i){t.cssNumber[e]=true}t.transit.propertyMap[e]=n.transform;t.cssHooks[e]={get:function(n){var i=t(n).css("transit:transform");return i.get(e)},set:function(n,i){var r=t(n).css("transit:transform");r.setFromString(e,i);t(n).css({"transit:transform":r})}}}function h(t){return t.replace(/([A-Z])/g,function(t){return"-"+t.toLowerCase()})}function b(t,e){if(typeof t==="string"&&!t.match(/^[\-0-9\.]+$/)){return t}else{return""+t+e}}function y(e){var n=e;if(typeof n==="string"&&!n.match(/^[\-0-9\.]+/)){n=t.fx.speeds[n]||t.fx.speeds._default}return b(n,"ms")}t.transit.getTransitionValue=d;return t});


$.fn.cssStop = function(){
	if(this.css("transform")){
		var arr = this.css("transform").split(/[)|, ]/);
		this.stop();
		if(this[0].timerClear) this[0].timerClear();
		if(arr.length == 12){
			var scale = arr[6];
			var x = arr[8];
			var y = arr[10];
			this.queue("fx",[]).css({x:x,y:y,scale:scale});
		}
	}else{
		this.stop();
	}
